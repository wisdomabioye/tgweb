...
var fullNormalize = (0, _pipe2.default)(_flatten2.default, (0, _chain2.default)((0, _split2.default)(',')), (0, _map2.default)(_trim2.default), (0, _reject2.default)(_isEmpty2.default), (0, _map2.default)(tagNormalize), (0, _join2.default)(''));
...
var isSingleObject = results => results.length === 1 && (0, _is2.default)(Object, results[0]);
...
var Logger = (moduleName, ...rest) => {
  ...
  var logFunction = (tag, objects) => {
    ...
    (0, _smartTimeout.immediate)(sheduler.add, debug, time, tag, objects);
  };
  var logger = (...tags) => {
